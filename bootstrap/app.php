...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        $middleware->alias([
            ...
            // Telnyx webhooks (Call Control events) — Ed25519 verify against
            // services.telnyx.public_key. See VerifyTelnyxSignature.
            'telnyx.webhook' => \App\Http\Middleware\VerifyTelnyxSignature::class,
        ]);
    })
