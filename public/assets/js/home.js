        ...
        success: function (response) {
            ...
            setTimeout(function() {
                ...
                for(var i = 0; i < barLenght.length; i++){
                    ...
                    TABLE_HTML += "<tr><td style='color: #2b7bc1;font-weight: bold;'>"+centre_name+"</td><td>"+(response.data.arrived[i])-(walkin)+"/"+(response.data.total[i])-(walkin)+"</td><td>"+walkin+"</td><td>"+((response.data.arrived[i]-walkin / response.data.total[i]-walkin) * 100).toFixed(2)+"%</td></tr>";  
                }
