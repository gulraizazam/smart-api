...
var AddConfValidation = function () {
    // Private functions
    var AddConfValidation = function () {
        let modal_id = 'modal_conf_bundles_form';
        let form = document.getElementById(modal_id);
        let validate = FormValidation.formValidation(
            form,
            {
...
var EditConfValidation = function () {
    // Private functions
    var EditConfValidation = function () {
        let modal_id = 'modal_edit_conf_bundles_form';
        let form = document.getElementById(modal_id);
        let validate = FormValidation.formValidation(
            form,
            {
...
jQuery(document).ready(function () {
    ...
    AddConfValidation.init();
    EditConfValidation.init();
});
