...
var table_url = route('admin.measurementhistoryform.datatable', {id: patientCardID});
...
function actions(data) {
    ...
    if (typeof data.id !== 'undefined') {
        ...
        let edit_url = route('admin.measurementhistoryform.edit', {id: id});
        let preview_url = route('admin.measurementhistoryform.previewform', {id: id});
