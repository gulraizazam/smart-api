...
class ConversionReportController extends Controller
{
    ...
    public function LoadConversionReport(Request $request)
    {
        ...
        list($report_data, $locationData,$maxConversion,$minConversion,$conversionsByPatient,$average_client_coversion,$arrival_to_conversion_ratio,$returnData ) = Finanaces::LoadConversionReport($request->all(), Auth::user()->account_id);
