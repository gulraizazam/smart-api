...
class AppointmentMedicalController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function fill_form(int $form_id, int $appointment_id): \Illuminate\View\View
    {
        if (! Gate::allows('appointments_medical_create')) {
            return abort(401);
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function submit_form(Request $request, int $id, int $appointment_id): \Illuminate\Http\JsonResponse
    {
        if (! Gate::allows('appointments_medical_create')) {
            return abort(401);
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update_medical_field(Request $request, int $id): \Illuminate\Http\JsonResponse
    {
        if (! Gate::allows('appointments_medical_edit')) {
            return abort(401);
        }
