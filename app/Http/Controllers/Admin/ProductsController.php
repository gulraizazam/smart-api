    ...
    public function logs($id)
    {
        try {
            ...
            $products_logs = collect($products_logs)->map(function ($log) use ($users, $brands, $centres, $warehouse) {
                ...
                $log->created_by = (array_key_exists($properties->created_by,[54434] )) ? $users[$properties->created_by]->name : 'N/A';
                $log->updated_by = (array_key_exists($properties->updated_by, [54434])) ? $users[$properties->updated_by]->name : 'N/A';
