...
class CustomFormFeedbackDetails extends BaseModal
{
     ...
     * @return  (mixed)
     */
    public static function createRecord($request, $form_id, $field, $feedback_id, $account_id, $user_id)
    {
     ...
     * @return (mixed)
     */
    public static function updateRecord(Request $request, $account_id, $user_id, $feedback_id, $feedback_field_id)
    {
