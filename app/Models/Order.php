...
class Order extends BaseModal
{
    ...
    protected $fillable = ['patient_id', 'product_id', 'location_id', 'warehouse_id', 'total_price', 'refund_order_id', 'order_type', 'payment_mode', 'created_by', 'updated_by', 'account_id', 'status'];
