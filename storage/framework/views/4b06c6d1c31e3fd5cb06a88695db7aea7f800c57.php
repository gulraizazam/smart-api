...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y ">
        <!--begin::Form-->
        <form id="modal_create_treatment_form" method="post" action="<?php echo e(route('admin.appointments.store_service')); ?>">
...
<!--end::Modal content-->
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/appointments/appointment-forms/treatment/create.blade.php ENDPATH**/ ?>