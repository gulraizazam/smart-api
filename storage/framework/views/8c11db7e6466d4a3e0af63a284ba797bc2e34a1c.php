...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        <!--begin::Form-->
        <form id="plane_edit_form" method="post" action="<?php echo e(route('admin.packages.edit_cash.store')); ?>">
...
<!--end::Modal content-->
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/packages/plane-edit.blade.php ENDPATH**/ ?>