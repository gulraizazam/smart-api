...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y ">
        <!--begin::Form-->
        <form id="modal_edit_treatment_form" method="post" action="<?php echo e(route('admin.appointments.store_service')); ?>">

            <?php echo method_field('put'); ?>

            <input type="hidden" id="appointment_manager" value="<?php echo e(Config::get('constants.appointment_type_service_string')); ?>">
...
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/appointments/appointment-forms/treatment/edit.blade.php ENDPATH**/ ?>