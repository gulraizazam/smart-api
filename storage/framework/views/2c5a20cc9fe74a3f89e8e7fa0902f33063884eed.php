                ...
                <div class="form-group">
                    <div class="row">
                        <div class="fv-row col-md-12">
                            ...
                            <input id="edit_user_name" type="text" name="name" value="<?php echo e($user->name ?? ''); ?>" class="form-control form-control-lg form-control-solid mb-2">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="fv-row col-md-6">
                            ...
                            <input id="edit_user_phone" type="text" oninput="phoneField(this)" name="phone" value="<?php echo e($user->phone ?? ''); ?>" class="form-control phone-field form-control-lg form-control-solid mb-2" />
                        ...
                        <div class="fv-row col-md-6">
                            ...
                            <input id="edit_user_email" type="email" name="email" value="<?php echo e($user->email ?? ''); ?>" class="form-control form-control-lg form-control-solid" />
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fv-row col-md-6">
                            ...
                            <div class="input-group">
                                <input id="edit_user_commission" type="number" min="0" maxlength="100" value="<?php echo e($user->commission ?? ''); ?>" name="commission" class="form-control commission-field form-control-lg form-control-solid mb-2"/>
...
<!--end::Modal content-->
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>