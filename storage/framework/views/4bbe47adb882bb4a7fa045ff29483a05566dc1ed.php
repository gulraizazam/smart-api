...
<div class="modal-content">
    ...
    <div class="modal-header" id="kt_modal_password_header">
        <!--begin::Modal title-->
        <h2 class="fw-bolder">Update Schedule</h2>
        <!--end::Modal title-->
        <!--begin::Close-->
    ...
    <div class="modal-body scroll-y ">
        <!--begin::Form-->
        <form id="modal_update_scheduled_form" method="post" action="<?php echo e(route('admin.appointments.updateSchedule')); ?>">
...
<!--end::Modal content-->
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/appointments/appointment-forms/schedule.blade.php ENDPATH**/ ?>