...
<div class="card mb-8 menu_section" style="width: 100%">
    ...
    <div class="card-body menu-card">
        <ul class="horizontal-nav-bar list-unstyled mb-0 appointment-menu">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('appointments_manage')): ?>
...
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/appointments/partials/consultancy-menu.blade.php ENDPATH**/ ?>