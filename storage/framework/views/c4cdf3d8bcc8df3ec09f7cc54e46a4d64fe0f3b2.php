 ...
 <div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        <!--begin::Form-->
        <form id="modal_add_permission_form" class="form" method="post" action="<?php echo e(route('admin.permissions.store')); ?>">
            <!--begin::Scroll-->
...
<!--end::Modal content-->
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/permissions/create.blade.php ENDPATH**/ ?>