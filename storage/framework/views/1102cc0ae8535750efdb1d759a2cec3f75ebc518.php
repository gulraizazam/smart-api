...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y ">
        <!--begin::Form-->
        <form id="modal_add_patients_form" method="post" action="<?php echo e(route('admin.patients.store')); ?>">
...
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/patients/create.blade.php ENDPATH**/ ?>