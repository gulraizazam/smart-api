...
<?php echo $__env->make('admin.partials.mobile-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script src="<?php echo e(asset('assets/js/pages/features/custom/spinners.js')); ?>"></script>

<script src="<?php echo e(asset('assets/js/pages/widgets.js')); ?>"></script>

<script>
    const debug = "<?php echo e(config('app.debug')); ?>";
</script>

<script src="<?php echo e(asset('assets/js/custom.js')); ?>"></script>

<?php echo $__env->yieldPushContent('datatable-js'); ?>

<script src="<?php echo e(asset('assets/js/pages/crud/ktdatatable/advanced/row-details.js')); ?>"></script>

<script src="<?php echo e(asset('assets/js/pages/crud/forms/widgets/select2.js')); ?>"></script>

<!--end::Page Scripts-->

<?php echo $__env->make('admin.partials.messages', ['toastr' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/layouts/master.blade.php ENDPATH**/ ?>