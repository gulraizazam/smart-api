...
<div class="modal-content">
    ...
    <div class="modal-header" id="kt_modal_password_header">
        <!--begin::Modal title-->
        <h2 class="fw-bolder rota-title">Appointment SMS Logs</h2>
        <!--end::Modal title-->
        <!--begin::Close-->
...
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/appointments/appointment-forms/sms-log.blade.php ENDPATH**/ ?>