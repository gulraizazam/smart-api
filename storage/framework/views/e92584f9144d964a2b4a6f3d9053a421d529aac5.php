<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('admin.partials.breadcrumb', ['module' => 'Treatments List', 'title' => 'Treatments'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <!--begin::Entry-->
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <?php echo $__env->make('admin.appointments.partials.treatment-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="card card-custom">
                        ...
                        <div class="card-toolbar">
                            ...
                            <?php if(Gate::allows('appointments_export_today')): ?>
                                <div class="export-appointments">
                                    <a id="today_consultancies" onclick="loadTodayAppointments('<?php echo e(date('Y-m-d')); ?>', 'treatment');" href="javascript:void(0);" class="btn btn-info font-weight-bolder">
                                        Today Treatments
                                    </a>
                                </div>&nbsp;&nbsp;&nbsp;
                            <?php endif; ?>
                    ...
                    <div class="card-body appointment appointment-section">
                        <!--begin::Search Form-->
                        <?php echo $__env->make('admin.appointments.treatment-filters', ['custom_reset' => 'custom_reset'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <!--end::Search Form-->
                    ...
                    <div class="card-body appointment treatment-section d-none">
                        ...
                        <?php echo $__env->make('admin.appointments.services.filters', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php $__env->startPush('js'); ?>
        ...
        <script>
            ...
            function setDashboardFilters() {
                ...
                if(result?.type != null ) {
                    ...
                    $("#treatment_search_start").val('<?php echo e(request('from')); ?>');
                    $("#treatment_appoint_end").val('<?php echo e(request('to')); ?>');
                    <?php
                        $ids = explode(',', request('center_id'));
                    ?>
                        <?php if(count($ids) == 1): ?>
                            $("#treatment_search_centre").val('<?php echo e(request('center_id')); ?>').change();
                        <?php endif; ?>

                    $("#treatment_search_status").val('<?php echo e(request('appoint_status')); ?>').change();
        ...
        <script src="<?php echo e(asset('assets/js/pages/appointment/treatment-calendar.js')); ?>"></script>

        <script src="<?php echo e(asset('assets/plugins/custom/fullcalendar/fullcalendar.bundle.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/js/pages/appointment/treatment-data.js')); ?>"></script>
    ...
    <?php $__env->startPush('datatable-js'); ?>
        ...
        <script src="<?php echo e(asset('assets/js/pages/appointment/treatmentDatatable.js')); ?>"></script>
    <?php $__env->stopPush(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/cuterav2.test/resources/views/admin/appointments/treatment.blade.php ENDPATH**/ ?>