...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y ">
        <!--begin::Form-->
        <form id="modal_create_consultancy_form" method="post" action="<?php echo e(route('admin.appointments.store')); ?>">
...
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/appointments/appointment-forms/create.blade.php ENDPATH**/ ?>