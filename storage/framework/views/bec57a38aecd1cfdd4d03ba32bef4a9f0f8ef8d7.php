<div class="mt-2 mb-7">
    ...
    <div class="row mb-6 plan-filters">
        ...
        <div class="col-lg-2 mb-lg-0 mb-6" id="patient_id">
            ...
            <input style="width: 110%;" class="form-control filter-field patient_id">
...
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/packages/filters.blade.php ENDPATH**/ ?>