...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        ...
        <!--begin::Form-->
        <form id="modal_add_user_form" method="post" action="<?php echo e(route('admin.users.store')); ?>">
            <!--begin::Scroll-->
...
<!--end::Modal content-->
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/users/create.blade.php ENDPATH**/ ?>