...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        <!--begin::Form-->
        <form id="modal_import_leads_form" method="post" action="<?php echo e(route('admin.leads.upload')); ?>" enctype="multipart/form-data">
            <!--begin::Scroll-->
            <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="fv-row col-md-12 mt-5">
                            ...
                            <p class="help-block">To download sample file <a href="<?php echo e(asset('assets/files/SampleLeads.xlsx')); ?>" target="_blank">click here</a> .</p>
...
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/leads/import.blade.php ENDPATH**/ ?>