...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        <!--begin::Form-->
        <form id="modal_convert_form" method="post" action="<?php echo e(route('admin.appointments.store')); ?>">
            <!--begin::Scroll-->
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="fv-row col-md-6 mt-5">
                            ...
                            <input type="text" name="scheduled_date" value="<?php echo e(date('Y-m-d')); ?>" id="schedule_date" class="form-control scheduled_date form-control-solid mb-3 mb-lg-0">
                        </div>

                        <div class="fv-row col-md-6 mt-5">
                            <label class="required fw-bold fs-6 mb-2 pl-0">Time </label>
                            <input id="schedule_time" name="scheduled_time" value="<?php echo e(date('h:i A')); ?>" class="form-control scheduled_time">
                        </div>
...
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/leads/convert.blade.php ENDPATH**/ ?>