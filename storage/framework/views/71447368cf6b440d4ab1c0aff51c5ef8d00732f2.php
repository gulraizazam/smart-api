...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y ">
        ...
        <form id="modal_edit_appointment_form" method="post" action="">
            ...
            <input type="hidden" id="appointment_manager" value="<?php echo e(config('constants.appointment_type_consultancy_string')); ?>">
...
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/appointments/appointment-forms/edit.blade.php ENDPATH**/ ?>