...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y ">
        <!--begin::Form-->
        <form id="modal_add_leads_form" method="post" action="<?php echo e(route('admin.leads.store')); ?>">
...
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/leads/create.blade.php ENDPATH**/ ?>