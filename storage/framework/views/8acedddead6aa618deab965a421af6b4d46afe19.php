...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        <!--begin::Form-->
        <form id="modal_add_services_form" method="post" action="<?php echo e(route('admin.services.store')); ?>">
            <!--begin::Scroll-->
...
<?php /**PATH /var/www/cuterav2.test/resources/views/admin/services/create.blade.php ENDPATH**/ ?>