        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="row">
                            ...
                            <div class="card-header border-0 bg-danger py-5">
                                ...
                                <div class="card-toolbar">
                                    <div class="dropdown dropdown-inline">
                                        <!-- <form id="dashboard-states" method="get" action="<?php echo e(route('admin.home')); ?>"> -->

                                           <select class="form-control" name="type" onchange="changeDate();" id="recordfilter">
                                               <option value="today"  <?php echo e(request('type') == 'today' ? 'selected' : ''); ?>>Today</option>
                                               <option value="yesterday" <?php echo e(request('type') == 'yesterday' ? 'selected' : ''); ?>>Yesterday</option>
                                               <option value="week" <?php echo e(request('type') == 'week' ? 'selected' : ''); ?>>This Week</option>
                                               <option value="month" <?php echo e(request('type') == 'month' ? 'selected' : ''); ?>>This Month</option>
                                           </select>
                                        ...
                                        <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                                    <span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
                                                        ...
                                                        <!--end::Svg Icon-->
                                                          ...
                                                          <span class="dashboard-counter" id="allrevenue"><?php echo e(!is_null($revenue) ? 'PKR: ' . number_format($revenue) : 'Your are not authorized'); ?></span>
                                                    </span>
                                        ...
                                        <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                                                <span class="svg-icon svg-icon-3x svg-icon-primary d-block my-2">
                                                    ...
                                                    <i class="la la-stethoscope" style="font-size: 40px;"></i>
                                                      ...
                                                      <span class="dashboard-counter" id="allconsult"><?php echo e(!is_null($done_consultancies) && !is_null($all_consultancies) ? $done_consultancies .'/'.$all_consultancies : 'Your are not authorized'); ?></span>
                                                </span>
                                            <?php if(!is_null($done_consultancies) && !is_null($all_consultancies)): ?>
                                                <a href="<?php echo e(route('admin.consultancy.index', ['type' => '1', 'from' => $start_date, 'to' => $end_date, 'center_id' => implode(',', $location_id)])); ?>" class="text-primary font-weight-bold font-size-h6 mt-2">Consultancies</a>
                                            <?php else: ?>
                                    ...
                                    <div class="row m-0">
                                        <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                                                    <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-2">
                                                       <i class="la la-medkit" style="font-size: 40px;"></i>
                                                         <span class="dashboard-counter" id="alltreat"><?php echo e(!is_null($done_treatments) && !is_null($all_treatments) ? $done_treatments .'/'. $all_treatments : 'Your are not authorized'); ?></span>
                                                    </span>
                                            <?php if(!is_null($done_treatments) && !is_null($all_treatments)): ?>
                                                <a href="<?php echo e(route('admin.treatment.index', ['type' => '2', 'from' => $start_date, 'to' => $end_date, 'center_id' => implode(',', $location_id)])); ?>" class="text-danger font-weight-bold font-size-h6 mt-2">Treatments</a>
                                            <?php else: ?>
                                        ...
                                        <div class="col bg-light-success px-6 py-8 rounded-xl">
                                                  <span class="svg-icon svg-icon-3x svg-icon-primary d-block my-2">
                                                      ...
                                                      <!--end::Svg Icon-->
                                                      <span class="dashboard-counter" id="allleads"><?php echo e($leads !== false && $totalLeads !== false ? $leads .'/'. $totalLeads : 'Your are not authorized'); ?></span>
                                                    </span>

                                            <a href="<?php echo e(route('admin.leads.index', ['from' => $start_date, 'to' => $end_date])); ?>" style="cursor: pointer;" class="text-success font-weight-bold font-size-h6 mt-2">Leads</a>
                                        </div>
                                    </div>
                                    <!--end::Row-->
                                </div>
                        ...
                        <div class="card card-custom card-stretch gutter-b" style="height: 600px; overflow-y: auto;">
                            ...
                            <div class="card-header align-items-center border-0 mt-4">
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-muted mt-3 font-weight-bold font-size-sm"><?php echo e(count($finance_log) + count($appointment_log)); ?> activities</span>
                                </h3>
                            </div>
                            <!--end::Header-->
                            <!--begin::Body-->
                            <div class="card-body pt-4">
                                ...
                                <?php if(count($finance_log) + count($appointment_log) > 0): ?>
                                    <div class="timeline timeline-6 mt-3">


                                        <?php $__currentLoopData = $appointment_log; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appoint_log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                            <div class="timeline-item align-items-start">
                                                    <!--begin::Label-->
                                                    <div class="timeline-label font-weight-bolder text-dark-75 font-size-lg"><?php echo e(\Illuminate\Support\Carbon::parse($appoint_log['time'])->format("h:i")); ?></div>
                                                    <!--end::Label-->
                                                    <!--begin::Badge-->
                                                   ...
                                                   <span class="font-weight-bolder text-dark-75 pl-3 font-size-lg">
                                                       <?php if($appoint_log['type'] == 'rescheduled'): ?>
                                                           <span style="color: #056FBF;"><?php echo e($appoint_log['action_by'] ?? 'N/A'); ?></span>
                                                           <?php echo e($appoint_log['action'] ?? 'N/A'); ?> <span style="color: #F5B183;"><?php echo e($appoint_log['screen'] ?? 'N/A'); ?></span>
                                                           for <span style="color: #3E7FBB;"><?php echo e($appoint_log['action_for']); ?></span>
                                                           to <?php echo e(\Illuminate\Support\Carbon::parse($appoint_log['date'])->format("d/m/Y") ?? 'N/A'); ?>

                                                       <?php elseif($appoint_log['type'] == 'booked'): ?>

                                                           <span style="color: #056FBF;"><?php echo e($appoint_log['action_by'] ?? 'N/A'); ?></span>
                                                           a <?php echo e($appoint_log['action'] ?? 'N/A'); ?>

                                                           <span style="color: #F5B183;"><?php echo e($appoint_log['screen'] ?? 'N/A'); ?></span>
                                                           for <span style="color: #3E7FBB;"><?php echo e($appoint_log['action_for']); ?></span>
                                                           at <span style="color: #F5B183;"><?php echo e(\Illuminate\Support\Carbon::parse($appoint_log['time'])->format("h:s A") ?? 'N/A'); ?> <?php echo e(\Illuminate\Support\Carbon::parse($appoint_log['date'])->format("d/m/Y") ?? 'N/A'); ?> </span>
                                                           in <?php echo e($appoint_log['address'] ?? 'N/A'); ?>
                                        ...
                                        <?php $__currentLoopData = $finance_log; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                        <div class="timeline-item align-items-start">
                                            <!--begin::Label-->
                                            <div class="timeline-label font-weight-bolder text-dark-75 font-size-lg"><?php echo e(\Illuminate\Support\Carbon::parse($log['created_at'])->format("h:i")); ?></div>
                                            <!--end::Label-->
                                            <!--begin::Badge-->
                                            <div class="timeline-badge">
                                            ...
                                            <div class="timeline-content font-weight-bolder font-size-lg text-dark-75 pl-3">
                                                <span style="color: #056FBF;"><?php echo e($log['user_id'] ?? 'N/A'); ?></span>
                                                <?php echo e($log['action'] ?? 'N/A'); ?> a payment of
                                                 <strong ><?php echo e($log['cash_amount']); ?></strong> for
                                                <span  style="color: #056FBF;"> <?php echo e($log['patient_id']); ?></span> against
                                                <span  style="color: #F5B183;"><?php echo e($log['appointment_type_id'] ?? 'Appointment'); ?></span>
                                                 In  <?php echo e($log['location_id']); ?> Centre
                                            </div>
                                            <!--end::Desc-->
                                        </div>
                    ...
                    <?php if(\Illuminate\Support\Facades\Gate::allows("dashboard_collection_by_centre")): ?>
                    ...
                    <?php if(\Illuminate\Support\Facades\Gate::allows('dashboard_my_collection_by_centre')): ?>
                    <div class="col-lg-12 col-xxl-12">
                    ...
                    <?php endif; ?>
                    <?php if(\Illuminate\Support\Facades\Gate::allows('dashboard_revenue_by_centre')): ?>
                    <div class="col-lg-12 col-xxl-12">
                    ...
                    <?php endif; ?>
                    <?php if(\Illuminate\Support\Facades\Gate::allows('dashboard_my_revenue_by_centre')): ?>
                    <div class="col-lg-12 col-xxl-12">
                    ...
                    <?php endif; ?>
                    <?php if(\Illuminate\Support\Facades\Gate::allows('dashboard_revenue_by_service')): ?>
                    <div class="col-lg-12 col-xxl-12">
                    ...
                    <?php endif; ?>
                    <?php if(\Illuminate\Support\Facades\Gate::allows('dashboard_my_revenue_by_service')): ?>
                    <div class="col-lg-12 col-xxl-12">
                    ...
                    <?php endif; ?>
                    <?php if(\Illuminate\Support\Facades\Gate::allows('dashboard_appointment_by_status')): ?>
                        <div class="col-lg-12 col-xxl-12">
                            <!--begin::MY REVENUE BY SERVICE-->
                            <div class="card card-custom card-stretch card-stretch-half gutter-b" style="min-height: 605px;">
                                <!--begin::Body-->
                    ...
                    <?php endif; ?>
                    <?php if(\Illuminate\Support\Facades\Gate::allows('dashboard_my_appointment_by_status')): ?>
                        <div class="col-lg-12 col-xxl-12">
                            <!--begin::MY REVENUE BY SERVICE-->
                            <div class="card card-custom card-stretch card-stretch-half gutter-b" style="min-height: 605px;">
                                <!--begin::Body-->
                    ...
                    <?php endif; ?>
                    <?php if(\Illuminate\Support\Facades\Gate::allows('dashboard_appointment_by_type')): ?>
                        <div class="col-lg-12 col-xxl-12">
                            <!--begin::MY REVENUE BY SERVICE-->
                            <div class="card card-custom card-stretch card-stretch-half gutter-b" style="min-height: 605px;">
                                <!--begin::Body-->
                    ...
                    <?php endif; ?>
                    <?php if(\Illuminate\Support\Facades\Gate::allows('dashboard_my_appointment_by_type')): ?>
                        <div class="col-lg-12 col-xxl-12">
                            <!--begin::MY REVENUE BY SERVICE-->
                            <div class="card card-custom card-stretch card-stretch-half gutter-b" style="min-height: 605px;">
                                <!--begin::Body-->
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dashboard_upcomings')): ?>
                    <div class="row">
                        <div class="col-lg-12 col-xxl-12">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
                                            <div class="btn-location">
                                                <button class="arrival-btn btn btn-default" onclick="getArrivalsByDate($(this), '<?php echo e($month); ?>', '<?php echo e($currentTime); ?>', 'month');">Month</button>
                                                <button class="arrival-btn btn btn-default" onclick="getArrivalsByDate($(this), '<?php echo e($startWeek); ?>', '<?php echo e($currentTime); ?>', 'week');">Week</button>
                                                <button class="arrival-btn btn btn-primary" onclick="getArrivalsByDate($(this), '<?php echo e($today); ?>', '<?php echo e($currentTime); ?>', 'today');">Today</button>
                                            </div>
...
<script src="<?php echo e(asset('assets/js/pages/dashboard/datatable.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/jsapi.js')); ?>"></script>

<script src="<?php echo e(asset('assets/js/pie.js')); ?>"></script>
    ...
    $(document).ready( function () {
       ...
       /*My revenue by service*/
        ...
        $.ajax({
            ...
            type: "GET",
            data: {'period': '<?php echo e(request('type')); ?>'},
            cache: false,
            success: function (response) {
        ...
        $.ajax({
            url: route('admin.dashboard.appointment_by_status'),
            type: "GET",
            data: {'period': '<?php echo e(request('type')); ?>',performance:"1"},
            cache: false,
            success: function (response) {
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/cuterav2.test/resources/views/admin/home.blade.php ENDPATH**/ ?>