...
- **MySQL 8 / MariaDB 10.6+ assumed.** Tables `utf8mb4` charset, `utf8mb4_0900_ai_ci` (or MariaDB equivalent) collation. Use **CTEs** and **window functions** for ranking/running totals instead of self-joins.
