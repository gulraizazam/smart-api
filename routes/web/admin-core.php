...
Route::post('update_password', [ChangePasswordController::class, 'changePassword'])->name('update_password');
...
Route::prefix('management-dashboard')
    ...
    ->group(function () {
        Route::get('/', [ManagementDashboardController::class, 'redirect'])->name('index');
        Route::get('/overview', [ManagementDashboardController::class, 'overview'])->name('overview');
        Route::get('/people', [ManagementDashboardController::class, 'people'])->name('people');
    });
