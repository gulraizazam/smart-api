...
use Illuminate\Support\Facades\Route;
    ...
    Route::post('reports/appointments', [\App\Http\Controllers\Api\Reports\AppointmentsReportController::class, '__invoke'])->middleware('permission:appointment_reports_manage')->name('api.reports.appointments');
    Route::post('reports/staff-wise-arrival', [\App\Http\Controllers\Api\Reports\StaffWiseArrivalController::class, '__invoke'])->middleware('permission:staff_wise_arrival_manage')->name('api.reports.staff-wise-arrival');
    Route::get('reports/staff-wise-arrival/filters', [\App\Http\Controllers\Api\Reports\StaffWiseArrivalController::class, 'filters'])->middleware('permission:staff_wise_arrival_manage')->name('api.reports.staff-wise-arrival.filters');
    Route::get('reports/doctor-revenue/filters', [\App\Http\Controllers\Api\Reports\DoctorRevenueReportController::class, 'filters'])->middleware('permission:doctor_revenue_manage')->name('api.reports.doctor-revenue.filters');
    Route::post('reports/doctor-revenue', [\App\Http\Controllers\Api\Reports\DoctorRevenueReportController::class, '__invoke'])->middleware('permission:doctor_revenue_manage')->name('api.reports.doctor-revenue');
    Route::post('reports/doctor-revenue/detail', [\App\Http\Controllers\Api\Reports\DoctorRevenueReportController::class, 'detail'])->middleware('permission:doctor_revenue_manage')->name('api.reports.doctor-revenue.detail');
    Route::post('reports/doctor-revenue/export', [\App\Http\Controllers\Api\Reports\DoctorRevenueReportController::class, 'export'])->middleware('permission:doctor_revenue_manage')->name('api.reports.doctor-revenue.export');
