...
use Illuminate\Support\Facades\Route;
    ...
    Route::resource('membershiptypes', MembershipTypesController::class)->except(['index', 'create', 'show']);
    ...
    Route::resource('memberships', MembershipsController::class)->except(['index', 'show']);
