                                                            ...
                                                            @if(array_key_exists($permission['key'] . $key, $permission['children']))
                                                                <label class="checkbox permission_checkbox">
                                                                    <input id="sub-allow_{{ $permission['children'][$permission['key'] . $key]['name'] }}"
                                                                           ...
                                                                           @if(isset($allowed_permissions[$permission['children'][$permission['key'] . $key]['id']])) checked="true" @endif
                                                                           onclick="FormValidation.checkMyParent(this,'allow_{{ $permission['name'] }}' , 'sub-allow_{{ $permission['name'] }}', '{{ $permission['children'][$permission['key'] . $key]['name'] }}' );">
