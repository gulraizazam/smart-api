...
@section('content')
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Roles List', 'title' => 'Roles'])
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-7 my-md-0">
                                            <div class="input-icon">
                                                <input type="text" class="form-control" placeholder="Name" id="search_name" />
                                                <span>
                                        ...
                                        <div class="col-md-3 my-md-0">
                                            <div class="input-icon">
                                                <input type="text" class="form-control" placeholder="Commission" id="search_commission" />
                                                <span>
                                                    <i class="flaticon2-search-1 text-muted"></i>
                                                </span>
                                            </div>
