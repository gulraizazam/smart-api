...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        <!--begin::Form-->
        <form id="modal_add_warehouse_form" method="post" action="{{route('admin.warehouse.store')}}">
            <!--begin::Scroll-->
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_warehouse_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="fv-row col-md-6">
                            ...
                            <select id="add_warehouse_cities" class="form-control form-control-solid mb-3 mb-lg-0 select2" name="city_id">
                        ...
                        <div class="fv-row col-md-6">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <div class="image-input image-input-outline" id="kt_image_1">
                                    <div class="image-input-wrapper" id="add_warehouse_image"></div>
