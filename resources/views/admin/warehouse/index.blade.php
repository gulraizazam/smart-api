...
@section('content')
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Warehouse', 'title' => 'Warehouse'])
                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Warehouses</h3>
                        </div>
                    ...
                    <div class="card-body">
                        <!--begin::Search Form-->
                    @include('admin.warehouse.filters')
                    <!--end::Search Form-->
    ...
    <div class="modal fade" id="modal_add_warehouse" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
    ...
    <div class="modal fade" id="modal_edit_warehouse" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
    ...
    @push('datatable-js')
        <script src="{{asset('assets/js/pages/admin_settings/warehouse.js')}}"></script>
    @endpush
