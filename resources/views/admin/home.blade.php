        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="row">
                    ...
                    @endif
                    @if(\Illuminate\Support\Facades\Gate::allows('dashboard_revenue_by_service_category'))
                        <div class="col-lg-12 col-xxl-12">
                            <div class="card card-custom card-stretch card-stretch-half gutter-b" style="min-height: 605px;">
                                <div class="card-body p-0">
                                    <div class="d-flex align-items-center justify-content-between card-spacer2 flex-grow-1">
                    ...
                    @endif
                    @if(\Illuminate\Support\Facades\Gate::allows('dashboard_collection_by_service_category'))
                        <div class="col-lg-12 col-xxl-12">
                            <div class="card card-custom card-stretch card-stretch-half gutter-b" style="min-height: 605px;">
                                <div class="card-body p-0">
                                    <div class="d-flex align-items-center justify-content-between card-spacer2 flex-grow-1">
    ...
    @push('datatable-js')
        ...
        <script>
            ...
            $(window).scroll(function(){
                ...
                if (($(window).scrollTop() >= ($(document).height() - $(window).height())*0.45) && !revenue_by_service_category){
