<div class="modal fade" id="modal_add_candidate" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 my-5">
                <form id="form_add_candidate" method="post" action="{{ route('admin.hr.recruitment.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <label class="fw-bold fs-6 mb-2">Upload CV</label>
