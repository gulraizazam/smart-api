...
@section('content')
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Lead Statuses', 'title' => 'Lead Statuses'])
                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Lead Statuses</h3>
                        </div>
                        <div class="card-toolbar">
                            ...
                            @endif
                            @can('lead_statuses_sort')
                            <a id="delete-table-rows" href="{{route('admin.lead_statuses.sort')}}" class="btn btn-info">
                    ...
                    <div class="card-body">
                        <!--begin::Search Form-->
                    @include('admin.lead_statuses.filters')
                    <!--end::Search Form-->
    ...
    <div class="modal fade" id="modal_add_region" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered form-popup" id="region-create">
            ...
            @include('admin.lead_statuses.create')
    ...
    <div class="modal fade" id="modal_edit_lead_statuses" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered form-popup" id="region-edit">
            ...
            @include('admin.lead_statuses.edit')
    ...
    @push('datatable-js')
        <script src="{{asset('assets/js/pages/admin_settings/lead_statuses.js')}}"></script>
    @endpush

    @push('js')
        <script src="{{asset('assets/js/pages/crud/forms/validation/admin_settings/lead_statuses.js')}}"></script>
    @endpush
