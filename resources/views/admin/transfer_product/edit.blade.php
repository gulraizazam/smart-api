...
<div class="modal-content">
    ...
    <div class="modal-header" id="kt_modal_edit_user_header">
        <!--begin::Modal title-->
        <h2 class="fw-bolder">Edit Transfer Product</h2>
        <!--end::Modal title-->
        <!--begin::Close-->
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        <!--begin::Form-->
        <form id="modal_edit_transfer_products_form" method="post" action="">
        @method('put')
        <!--begin::Scroll-->
                ...
                <div class="form-group">
                    ...
                    <div class="row mb-2">
                        <div class="fv-row col-md-6">
                            ...
                            <input type="number" id="edit_total_stock"
                        ...
                        <div class="fv-row col-md-6">
                            <label class="required fw-bold fs-6 mb-2 pl-0">Transfer Stock Quantity <span
                                    class="text text-danger">*</span></label>
                            <input type="number" id="edit_product_quantity" name="quantity"
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6 mb-6">
                            <label class="required fw-bold fs-6 mb-2 pl-0">Transfer Date <span
                                class="text text-danger">*</span></label>
                            <input type="text" id="edit_transfer_date" class="custom-datepicker form-control filter-field datatable-input" name="transfer_date" placeholder="Transfer Date" data-col-index="5">
                        </div>
                    </div>
                </div>
            </div>
