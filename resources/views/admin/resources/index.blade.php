...
@section('content')
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Resource List', 'title' => 'Resources'])
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        <!--begin::Search Form-->
                    @include('admin.resources.filters')
                    <!--end::Search Form-->
    ...
    @push('datatable-js')
        <script src="{{asset('assets/js/pages/admin_settings/resources.js')}}"></script>
    @endpush
