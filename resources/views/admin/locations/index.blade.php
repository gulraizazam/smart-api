...
@section('content')
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Centre List', 'title' => 'Centres'])
                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Centres</h3>
                        </div>
                    ...
                    <div class="card-body">
                        <!--begin::Search Form-->
                    @include('admin.locations.filters')
                    <!--end::Search Form-->
    ...
    @push('datatable-js')
        <script src="{{asset('assets/js/pages/admin_settings/locations.js')}}"></script>
    @endpush
