...
@section('content')
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Appointment Statuses', 'title' => 'Appointment Statuses'])
                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Appointment Statuses</h3>
                        </div>
                    ...
                    <div class="card-body">
                        <!--begin::Search Form-->
                    @include('admin.appointment_statuses.filters')
                    <!--end::Search Form-->
    ...
    <div class="modal fade" id="modal_add_region" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered form-popup" id="region-create">
            ...
            @include('admin.appointment_statuses.create')
    ...
    <div class="modal fade" id="modal_edit_lead_statuses" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered form-popup" id="region-edit">
            ...
            @include('admin.appointment_statuses.edit')
    ...
    @push('datatable-js')
        <script src="{{asset('assets/js/pages/admin_settings/appointment_statuses.js')}}"></script>
    @endpush
