...
<div class="modal-content">
    ...
    <div class="modal-header" id="kt_modal_edit_user_header">
        <!--begin::Modal title-->
        <h2 class="fw-bolder">Edit Appointment Status</h2>
        <!--end::Modal title-->
        <!--begin::Close-->
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        <!--begin::Form-->
        <form id="modal_edit_appointment_statuses_form" method="post" action="">
        @method('put')
        <!--begin::Scroll-->
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="fv-row col-md-6">
                            ...
                            <input type="text" id="edit_appointment_statuses_name" name="name" class="form-control form-control-lg form-control-solid mb-2">
                        </div>
                        <div class="fv-row col-md-6">
                            <label class="required fw-bold fs-6 mb-2 pl-0">Parent</label>
                            <select name="parent_id" id="edit_appointment_statuses_parent_id" class="form-control select2">
                    ...
                    <div class="row mt-5">
                        <div class="fv-row col-md-6">
                            ...
                            <div class="checkbox-inline">
                                <label class="checkbox"><input id="edit_appointment_statuses_is_comment" name="is_comment" value="1" type="checkbox"/><span></span>Yes</label>
                            </div>
                        </div>
                        <div class="fv-row col-md-6 not-have-parent">
                            <label class="required fw-bold fs-6 mb-2 pl-0">Allow SMS for this Status?</label>
                            <div class="checkbox-inline">
                                <label class="checkbox"><input id="edit_appointment_statuses_allow_message" name="allow_message" value="1" type="checkbox"/><span></span>Yes</label>
                            </div>
                        </div>
                    </div>
