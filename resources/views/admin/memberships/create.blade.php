...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y ">
        <!--begin::Form-->
        <form id="modal_add_memberships_form" method="post" action="{{route('admin.memberships.store')}}">
                ...
                <div class="form-group">
                    ...
                    <div class="fv-row col-md-6 mt-5">
                        ...
                        <div class="fv-row col-md-6 mt-5">
                            ...
                            <select id="add_membership_type_id" class="form-control form-control-solid mb-3 mb-lg-0 select2" name="membership_type_id">
                            </select>
                        </div>
                    </div>
