    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-submenu {{ openMenu(['admin.hr.dashboard', 'admin.hr.employees.index', 'admin.hr.employees.show', 'admin.hr.departments.index', 'admin.hr.designations.index', 'admin.hr.leave-types.index', 'admin.hr.leave-balances.index', 'admin.hr.leave-applications.index', 'admin.hr.leave-applications.calendar', 'admin.hr.recruitment.index', 'admin.hr.recruitment.show', 'admin.hr.reports.birthdays', 'admin.hr.reports.anniversaries']) }}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <i class="font-icon la la-users"></i>
                        </span>
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            @endcan
                            @can('hr_employees_view')
                            <li class="menu-item {{ activeMenu('admin.hr.reports.birthdays') }}" aria-haspopup="true">
                                <a href="{{ route('admin.hr.reports.birthdays') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                    <span class="menu-text">Birthdays</span>
                                </a>
                            </li>
                            <li class="menu-item {{ activeMenu('admin.hr.reports.anniversaries') }}" aria-haspopup="true">
                                <a href="{{ route('admin.hr.reports.anniversaries') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                    <span class="menu-text">Anniversaries</span>
                                </a>
                            </li>
                            @endcan
                        </ul>
