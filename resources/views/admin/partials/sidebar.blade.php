    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <div class="flex-column-auto d-lg-none pt-4 pb-7" id="kt_brand" style="border-bottom: 1px solid #032f58;">
                <!--begin::Logo-->
                <a class="brand-logo">
                    <img style="width: 130px;margin-left:25px; display:block;" alt="Logo"
                        src="{{ asset('logo.png') }}" />
                </a>
                <!--end::Logo-->
            </div>
            ...
            <ul class="menu-nav">
                ...
                @if (Gate::allows('permissions_manage') ||
                    ...
                    <li class="menu-item menu-item-submenu {{ openMenu(['admin.permissions.index', 'admin.users.index', 'admin.roles.index', 'admin.roles.edit', 'admin.users.index', 'admin.doctors.index', 'admin.user_types.index']) }}"
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                ...
                                @can('roles_manage')
                                    <li class="menu-item {{ activeMenu('admin.roles.index') }} {{ activeMenu('admin.roles.edit') }}"
                                        aria-haspopup="true">
                ...
                @if (Gate::allows('patients_manage'))
                    <li class="menu-item menu-item-submenu {{ openMenu(['admin.patients.index', 'admin.patients.preview']) }}"
                        aria-haspopup="true" data-menu-toggle="hover">
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                @can('patients_manage')
                                    <li class="menu-item {{ activeMenu('admin.patients.index') }} {{ activeMenu('admin.patients.preview') }}"
                                        aria-haspopup="true">
                ...
                @if (Gate::allows('leads_manage'))
                    <li class="menu-item menu-item-submenu {{ openMenu(['admin.leads.index']) }}"
                        aria-haspopup="true" data-menu-toggle="hover">
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                ...
                                @can('leads_create')
                                    <li class="menu-item {{ isActive(url('admin/leads?create=create'), 'create') }}"
                                        aria-haspopup="true">
                                        <a href="{{ route('admin.leads.index', ['create' => 'create']) }}"
                                            class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                ...
                                @can('leads_manage')
                                    <li class="menu-item {{ isActive(url('admin/leads'), 'other') }}"
                                        aria-haspopup="true">
                                ...
                                @can('leads_junk')
                                    <li class="menu-item {{ isActive(url('admin/leads?type=junk'), 'junk') }}"
                                        aria-haspopup="true">
                ...
                @if (Gate::allows('appointments_manage'))
                    <li class="menu-item menu-item-submenu {{ openMenu(['admin.consultancy.index']) }} {{ openMenu(['admin.treatment.index']) }} {{ openMenu(['admin.appointments.index']) }}"
                        aria-haspopup="true" data-menu-toggle="hover">
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                ...
                                @can('appointments_consultancy')
                                    <li class="menu-item manage-consultancy {{ activeMenu('admin.consultancy.index') }}"
                                        aria-haspopup="true">
                                ...
                                @can('appointments_services')
                                    <li class="menu-item manage-treatment {{ activeMenu('admin.treatment.index') }}"
                                        aria-haspopup="true">
                ...
                @if (Gate::allows('services_manage') || Gate::allows('packages_manage') || Gate::allows('discounts_manage'))
                    <li class="menu-item menu-item-submenu {{ openMenu(['admin.services.index']) }} {{ openMenu(['admin.bundles.index']) }} {{ openMenu(['admin.discounts.index']) }}"
                        aria-haspopup="true" data-menu-toggle="hover">
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                ...
                                @can('services_manage')
                                    <li class="menu-item manage-consultancy {{ activeMenu('admin.services.index') }}"
                                        aria-haspopup="true">
                                ...
                                @can('packages_manage')
                                    <li class="menu-item manage-treatment {{ activeMenu('admin.bundles.index') }}"
                                        aria-haspopup="true">
                                ...
                                @can('discounts_manage')
                                    <li class="menu-item manage-treatment {{ activeMenu('admin.discounts.index') }}"
                                        aria-haspopup="true">
                ...
                @if (Gate::allows('resourcerotas_manage'))
                    <li class="menu-item {{ activeMenu('admin.resourcerotas.index') }} {{ activeMenu('admin.resourcerotas.calender-view') }}"
                        aria-haspopup="true">
                    ...
                    <li class="menu-item menu-item-submenu {{ openMenu([
                        ...
                        @can('user_operator_settings_manage')
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ activeMenu('admin.user_operator_settings.index') }}"
                                        aria-haspopup="true">
                        ...
                        @can('payment_modes_manage')
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ openMenu(['admin.payment_modes.index', 'admin.payment_modes.sort'], 'menu-item-active') }}"
                                        aria-haspopup="true">
                        ...
                        @can('regions_manage')
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ openMenu(['admin.regions.index', 'admin.regions.sort'], 'menu-item-active') }}"
                                        aria-haspopup="true">
                        ...
                        @can('cities_manage')
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ openMenu(['admin.cities.index', 'admin.cities.sort'], 'menu-item-active') }}"
                                        aria-haspopup="true">
                        ...
                        @can('lead_sources_manage')
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ openMenu(['admin.lead_sources.index', 'admin.lead_sources.sort'], 'menu-item-active') }}"
                                        aria-haspopup="true">
                        ...
                        @can('lead_statuses_manage')
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ openMenu(['admin.lead_statuses.index', 'admin.lead_statuses.sort'], 'menu-item-active') }}"
                                        aria-haspopup="true">
                        ...
                        @can('appointment_statuses_manage')
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ activeMenu('admin.appointment_statuses.index') }}"
                                        aria-haspopup="true">
                        ...
                        @can('machineType_manage')
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ activeMenu('admin.machine_types.index') }}"
                                        aria-haspopup="true">
                        ...
                        @can('sms_templates_manage')
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ activeMenu('admin.sms_templates.index') }}"
                                        aria-haspopup="true">
                        ...
                        @can('centre_targets_manage')
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ activeMenu('admin.centre_targets.index') }}"
                                        aria-haspopup="true">
                        ...
                        @can('finances_manage')
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ activeMenu('admin.packagesadvances.index') }}"
                                        aria-haspopup="true">
                        ...
                        @can('custom_form_feedbacks_manage')
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ activeMenu('admin.custom_form_feedbacks.index') }} {{ activeMenu('admin.custom_form_feedbacks.filled_preview') }}"
                                        aria-haspopup="true">
                        ...
                        @can('custom_forms_manage')
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ activeMenu('admin.custom_forms.index') }}"
                                        aria-haspopup="true">
                ...
                @if (Gate::allows('inventory_manage'))
                    @can('inventory_manage')
                        <li class="menu-item menu-item-submenu {{ openMenu(['admin.warehouse.index']) }} {{ openMenu(['admin.brands.index']) }} {{ openMenu(['admin.products.index']) }} {{ openMenu(['admin.products.logs']) }} {{ openMenu(['admin.products.stock']) }} {{ openMenu(['admin.transfer_product.index']) }} {{ openMenu(['admin.orders.index']) }} {{ openMenu(['admin.order.refunds.index']) }}"
                            aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            @can('transfer_product_manage')
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ activeMenu('admin.transfer_product.index') }}"
                                            aria-haspopup="true">
                            ...
                            @can('refund_manage')
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ activeMenu('admin.order.refunds.index') }}"
                                            aria-haspopup="true">
                ...
                <!-- End Inventory menu -->
                <li class="menu-item menu-item-submenu {{ openMenu(['admin.reports.finance_reports', 'admin.reports.operations_report', 'admin.reports.inventory_report']) }}"
                    aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    @can('finance_general_revenue_reports_manage')
                        <div class="menu-submenu">
                            <i class="menu-arrow"></i>
                            <ul class="menu-subnav">
                                <li class="menu-item {{ activeMenu('admin.reports.finance_reports') }}"
                                    aria-haspopup="true">
                    ...
                    @can('operations_reports_manage')
                        <div class="menu-submenu">
                            <i class="menu-arrow"></i>
                            <ul class="menu-subnav">
                                <li class="menu-item {{ activeMenu('admin.reports.operations_report') }}"
                                    aria-haspopup="true">
                    ...
                    @can('non_converted_customers_manage')
                        <div class="menu-submenu">
                            <i class="menu-arrow"></i>
                            <ul class="menu-subnav">
                                <li class="menu-item {{ activeMenu('admin.reports.arrived_not_converted') }}"
                                    aria-haspopup="true">
                    ...
                    @can('staff_wise_arrival_manage')
                        <div class="menu-submenu">
                            <i class="menu-arrow"></i>
                            <ul class="menu-subnav">
                                <li class="menu-item {{ activeMenu('admin.reports.staff_wise_arrival') }}"
                                    aria-haspopup="true">
