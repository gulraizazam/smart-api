<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="fv-row col-md-3 mt-5">
                        ...
                        <input type="text" readonly oninput="phoneField(this)" id="package_total_bundle" class="form-control" value="0" name="package_total_bundle">
                    </div>
                    <div class="fv-row col-md-3 mt-5">
        ...
        <div class="text-center">
            <button type="button" class="btn btn-light me-3"  onclick="resetVoucherAddBundle(event)">Cancel</button>
