    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="fv-row col-md-3 mt-5">
                            ...
                            <input type="text" id="edit_bundle_package_total_1" readonly class="form-control" name="package_total_1" value="0">
                        </div>
        ...
        <div class="row">
            <div class="table-responsive">
                <h4>History</h4>
                <table id="edit_bundle_plan_history" class="table table-bordered table-advance">
