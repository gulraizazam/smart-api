                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Voucher Usage Details: {{ $voucher->name }}</h3>
                        </div>

                        <div class="card-toolbar">
                            <a href="{{ route('admin.voucherTypes.index') }}" class="btn btn-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="mb-4">Services & Packages Using This Voucher</h4>
