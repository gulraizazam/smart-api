...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        <!--begin::Form-->
        <form id="modal_allocate_vouchers_form" method="post" action="">
            <!--begin::Scroll-->
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="fv-row col-md-5 mt-5">
                            ...
                            <select id="locations" onchange="getDesrvice($(this));" class="form-control form-control-solid mb-3 mb-lg-0 select2" name="location_id">
