        ...
        <div class="col-md-10">
            ...
            <div class="input-icon mb-1" style="width: 215px;">
                ...
                @if (isset($custom_reset) && $custom_reset != '')
                    <button class="btn btn-secondary btn-secondary--icon ml-3" onclick="resetCustomFilters();"
                        id="reset-filters">
                        <i class="la la-close"></i>
                        Reset
                    </button>
                @else
                    <button class="btn btn-secondary btn-secondary--icon ml-3" onclick="resetFilterOrder();"
                        id="reset-filters">
                        <i class="la la-close"></i>
                        Reset
                    </button>
