...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        <!--begin::Form-->
        <form id="modal_edit_brands_form" method="post" action="">
        @method('put')
        <!--begin::Scroll-->
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="fv-row col-md-12">
                            ...
                            <input type="text" id="edit_brands_name" name="name" class="form-control form-control-lg form-control-solid mb-2">
                        </div>
                    </div>
                </div>
