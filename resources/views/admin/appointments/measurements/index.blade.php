...
@section('content')
            ...
            <div class="container">
                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        ...
                        <div class="card-toolbar">
                            ...
                            @if(Gate::allows('appointments_measurement_create'))
                                <a href="javascript:void(0);" onclick="addMeasurementForm('{{route('admin.appointmentsmedical.create', request('id'))}}');" class="btn btn-primary" data-toggle="modal" data-target="#modal_add_measurement_form">
                    ...
                    <div class="card-body">
                        ...
                        <!--begin::Search Form-->
                        @include('admin.appointments.measurements.filters')
                        <!--end::Search Form-->
                        <!--begin: Datatable-->
    ...
    <div class="modal fade" id="modal_add_measurement_form" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
    ...
    @push('datatable-js')
        ...
        <script src="{{asset('assets/js/pages/appointment/measurement-datatable.js')}}"></script>
