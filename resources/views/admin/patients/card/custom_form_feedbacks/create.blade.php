                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        ...
                        <div class="card-toolbar">
                            <div class="card-toolbar">
                                <!--begin::Dropdown-->
                                <a href="{{ route('admin.patients.preview', request('patient_id')) }}" class="btn btn-sm btn-dark" >
                    ...
                    <div class="card-body">
                        <form id="cf_form">
                            <div class="form-group">
                                ...
                                <div class="form-group form-md-line-input cf_main_title patient_custom_form">
                                    <div class="form-group form-md-line-input cf_input_question patient_custom_form">
                                        <h2 class="rs-head">{{$custom_form->name}}</h2>
                                    </div>
                                </div>
                                <input id="form_id" name="form_id" type="hidden" value="{{$custom_form->id}}"/>
                                <input class="patient_id" name="patient_id" type="hidden" value="{{request('id')}}"/>
                                ...
                                <div class="margin-top-10">
                                    ...
                                    <a href="{{route('admin.patients.preview', request('patient_id')) }}" class="btn btn-danger">Cancel </a>
                                </div>
                            </div>
                        </form>
            ...
            $("#cf_form").submit(function(e){
                ...
                if($("#cf_form").valid()) {
                    ...
                    fill_form(data, (response) => {
                        ...
                        window.location.href = '{{route('admin.patients.preview', request('patient_id')) }}';
                    });
                } else {
