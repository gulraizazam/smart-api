    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-3 mb-lg-0 mb-6">
            ...
            <div class="input-daterange input-group to-from-datepicker" >
                <input type="text" id="invoice_search_created_from" class="form-control filter-field datatable-input" name="created_from" placeholder="From" data-col-index="5">
                <div class="input-group-append">
                    <span class="input-group-text">
                        <i class="la la-ellipsis-h"></i>
                    </span>
                </div>
                <input type="text" id="invoice_search_created_to" class="form-control filter-field datatable-input" name="created_to" placeholder="To" data-col-index="5">
            </div>
        </div>
