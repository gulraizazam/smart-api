...
@section('patient_content')
    <div class="portlet-title tabbable-line">
        <div class="caption caption-md">
            ...
            <span class="caption-subject font-blue-madison bold uppercase">@lang('global.measurement_form.title')</span>
        </div>
    </div>
        ...
        <div class="table-container">
            <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                ...
                <tr role="row" class="heading">
                    <th>@lang('global.measurement_form.fields.name')</th>
                    <th>@lang('global.measurement_form.fields.patient_name')</th>
                    <th>@lang('global.measurement_form.fields.created_at')</th>
                    <th width="20%">@lang('global.measurement_form.fields.actions')</th>
                </tr>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/patients/card/measurement_history/datatable.js') }}"
            type="text/javascript"></script>
