...
@section('content')
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Measurement History Form', 'title' => 'Measurement History Form'])
                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Measurement History Form</h3>
                        </div>

                        <div class="card-toolbar">
                            <a href="{{route('admin.measurementhistoryform.index',[$patient_id]) }}" class="btn btn-sm btn-dark">
