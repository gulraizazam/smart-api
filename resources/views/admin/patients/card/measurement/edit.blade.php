...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.measurement_form.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="{{ route('admin.measurementhistoryform.index',[$patient_id]) }}"
            ...
            <script type="text/javascript">
                ...
                function update_feedback(success_callback, error_callback) {
                    ...
                    $.ajax({
                        ...
                        url: '{{route('admin.measurementhistoryform.update',['Id'=>$custom_form->id])}}',
                        type: 'POST',
                        data: data,
                        cache: false,
                        success: success_callback,
