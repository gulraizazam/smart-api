...
@section('patient_content')
    <div class="portlet-title tabbable-line">
        <div class="caption caption-md">
            ...
            <span class="caption-subject font-blue-madison bold uppercase">@lang('global.medical_history.title')</span>
        </div>
    </div>
        ...
        <div class="table-container">
            <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                ...
                <tr role="row" class="heading">
                    <th>@lang('global.medical_history.fields.name')</th>
                    <th>@lang('global.medical_history.fields.patient_name')</th>
                    <th>@lang('global.medical_history.fields.created_at')</th>
                    <th width="20%">@lang('global.medical_history.fields.actions')</th>
                </tr>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/patients/card/medical_history/datatable.js') }}"
            type="text/javascript"></script>
