<div class="mt-2 mb-7">
    ...
    <div class="row mb-6 align-items-end">
        ...
        <div class="col-lg-2 mb-lg-0 mb-6 @if($errors->has('date_range')) has-error @endif">
        ...
        <div class="col-lg-4 mb-lg-0 mb-6">
            <div class="d-flex align-items-center" style="gap: 5px;">
                <button class="btn btn-primary" id="apply-filters" title="Search"><i class="la la-search p-0"></i></button>
                <button class="btn btn-light" id="reset-filters" type="button" onclick="resetFilters();" title="Reset"><i class="la la-undo p-0"></i></button>
            </div>
        </div>
    </div>
