...
@section('content')
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Operator Settings', 'title' => 'Operator Settings'])
                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Operator Settings</h3>
                        </div>
                    ...
                    <div class="card-body">
                        <!--begin::Search Form-->
                    @include('admin.user_operator_settings.filters')
                    <!--end::Search Form-->
