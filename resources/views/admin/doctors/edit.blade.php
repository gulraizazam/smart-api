                ...
                <div class="form-group">
                    <div class="row">
                        <div class="fv-row col-md-12">
                            ...
                            <input id="edit_user_name" type="text" name="name"  class="form-control form-control-lg form-control-solid mb-2">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="fv-row col-md-6">
                            ...
                            <input id="edit_user_phone" type="text" name="phone" oninput="phoneField(this);" class="form-control phone-field form-control-lg form-control-solid mb-2" />
                        ...
                        <div class="fv-row col-md-6">
                            ...
                            <input id="edit_user_email" type="email" name="email" class="form-control form-control-lg form-control-solid" />
                        </div>
...
{{--                                <option value="2">Female</option>--}}
                ...
                <div class="form-group">
                    ...
                    <div class="row mt-10" id="edit_can_perform_consultation_row" style="display: none;">
                        <div class="fv-row col-md-12">
                            <label class="form-check form-check-custom form-check-solid">
                                <input class="form-check-input" type="checkbox" name="can_perform_consultation" id="edit_doctor_can_perform_consultation" value="1" />
