...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        @include('admin.partials.breadcrumb', ['module' => 'Doctors', 'title' => 'Doctors'])
                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Doctors List</h3>
                        </div>
    ...
    @push('datatable-js')
        <script src="{{asset('assets/js/pages/admin_settings/doctors.js')}}"></script>
    @endpush
