...
<div class="invoice-pdf">
    ...
    <table class="mt-0">
        <tr>
            <td><img class="logo" src="{{ !empty($download) ? public_path('assets/media/new_logo.png') : asset('assets/media/new_logo.png') }}" style="width:255px; margin-top: -25px;" class="img-responsive" alt=""/></td>
    ...
    <table class="layout-fixed client-info" style="margin-top: 10px;">
        ...
        <tr>
            <td><strong style="width: 75px; display: inline-block;">Patient ID:</strong> <span style="padding-left: 5px;">{{'C-'.$patient->id}}</span></td>
