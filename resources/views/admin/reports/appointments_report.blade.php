...
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/2.3.6/css/buttons.dataTables.min.css">
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Reports', 'title' => 'Appointments Report'])
    <!--begin::Entry-->
                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Appointments Report</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="mt-2 mb-7">
                                ...
                                <div class="col-lg-12 col-xl-12">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="form-group col-md-3 sn-select @if($errors->has('centre_id')) has-error @endif"
                                            ...
                                            <select class="form-control select2" id="centre_id" name="centre_id[]" multiple data-placeholder="All (select to filter)" style="width: 100%;">
                                        ...
                                        <div class="form-group col-md-2 sn-select @if($errors->has('doctor_id')) has-error @endif" id="users" >
                                           ...
                                           <select class="form-control select2" id="time_id" name="time_id">
                                       ...
                                       <div class="form-group col-md-2 sn-select @if($errors->has('doctor_id')) has-error @endif" id="users" >
                                        ...
                                        <div style="overflow: hidden; width: 100%;" id="apt_content"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
