...
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/2.3.6/css/buttons.dataTables.min.css">
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Reports', 'title' => 'Conversion Report'])
    <!--begin::Entry-->
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-12 col-xl-12">
                                    <div class="row align-items-center">
                                        ...
                                        {!! Form::label('Date Range', 'Date Range:', ['class' => 'control-label']) !!}
                                        ...
                                        <div class="form-group col-md-2 sn-select @if($errors->has('group_id')) has-error @endif">
                                            ...
                                            <a href="javascript:void(0);" onclick="loadConversionReport($(this));" id="load_conversion_report"
    ...
    @push('datatable-js')
        ...
        <script src="{{asset('assets/js/conversion.js')}}"></script>       
    @endpush
