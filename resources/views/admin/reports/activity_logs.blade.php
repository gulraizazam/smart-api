                                    ...
                                    <div class="timeline custom_timeline timeline-6 mt-3">
                                        <div class="timeline-item align-items-start">
                                            <div class="timeline-label font-weight-bolder text-dark-75 font-size-sm">
                                                Aug 13, 2023 at 01:00 PM
                                            </div>
                                            <div class="timeline-badge">
                                                <i class="fa fa-genderless text-primary icon-xl"></i>
                                            </div>
                                            <div class="timeline-content font-size-lg text-dark-75 pl-3">
                                                <strong>john Doe</strong> booked   <a href="#"><strong class="text-primary">Hydrafacial Platinum</strong></a> consultation for <strong>Marry Handy</strong> in <strong>CUTERA DHA Karachi</strong> on <strong>Aug 15, 2023 at 01:00 PM</strong>
                                            </div>
                                        </div>
                                        <div class="timeline-item align-items-start">
                                            <div class="timeline-label font-weight-bolder text-dark-75 font-size-sm">
                                            ...
                                            <div class="timeline-content font-size-lg text-dark-75 pl-3">
                                                <strong>john Doe</strong> booked   <a href="#"><strong class="text-success">Hydrafacial Platinum</strong></a> consultation for <strong>Marry Handy</strong> in <strong>CUTERA DHA Karachi</strong> on <strong>Aug 15, 2023 at 01:00 PM</strong>
                                            </div>
                                        </div>
                                        <div class="timeline-item align-items-start">
                                            <div class="timeline-label font-weight-bolder text-dark-75 font-size-sm">
                                            ...
                                            <div class="timeline-content font-size-lg text-dark-75 pl-3">
                                                <strong>john Doe</strong> booked   <a href="#"><strong class="text-warning">Hydrafacial Platinum</strong></a> consultation for <strong>Marry Handy</strong> in <strong>CUTERA DHA Karachi</strong> on <strong>Aug 15, 2023 at 01:00 PM</strong>
                                            </div>
                                        </div>
                                        <div class="timeline-item align-items-start">
                                            <div class="timeline-label font-weight-bolder text-dark-75 font-size-sm">
                                            ...
                                            <div class="timeline-content font-size-lg text-dark-75 pl-3">
                                                <strong>john Doe</strong> booked   <a href="#"><strong class="text-danger">Hydrafacial Platinum</strong></a> consultation for <strong>Marry Handy</strong> in <strong>CUTERA DHA Karachi</strong> on <strong>Aug 15, 2023 at 01:00 PM</strong>
                                            </div>
                                        </div>
                                        <div class="timeline-item align-items-start">
                                            <div class="timeline-label font-weight-bolder text-dark-75 font-size-sm">
