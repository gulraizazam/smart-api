...
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/2.3.6/css/buttons.dataTables.min.css">
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Reports', 'title' => 'Doctor Revenue Report'])
    <!--begin::Entry-->
                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Doctor Revenue Report</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="mt-2 mb-7">
                                ...
                                <div class="col-lg-12 col-xl-12">
                                    ...
                                    <div class="form-group col-md-3 sn-select @if($errors->has('centre_id')) has-error @endif"
                                        ...
                                        <div class="form-group col-md-2 sn-select @if($errors->has('group_id')) has-error @endif">
                                            ...
                                            <a href="javascript:void(0);" onclick="loadDoctorRevenueReport($(this));" id="load_doctor_revenue_report"
                                               class="btn btn-success spinner-button">Load Report</a>
                                        </div>
                                        <div class="clear clearfix"></div>
                                        <div style="overflow: hidden; width: 100%;" id="doctor_revenue_content">
    ...
    @push('datatable-js')
        ...
        <script>
            function loadDoctorRevenueReport(btn) {
                var centreId = $('#centre_id').val();
                var dateRange = $('#date_range_ratings').val();
                
                if (!centreId) {
                    toastr.error('Please select a centre');
                    return;
                }
                ...
                $.ajax({
                    url: "{{ route('admin.reports.load_doctor_revenue_report') }}",
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        centre_id: centreId,
                    ...
                    success: function(response) {
                        $('#doctor_revenue_content').html(response);
