...
@section('content')
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Inventory Report', 'title' => 'Inventory Report'])
    <!--begin::Entry-->
                    ...
                    <!--end::Search Form-->
                        ...
                        <div style="width: 100%;" id="datatable_stock_report">
                            <table class="table table-bordered">
                                ...
                                <th>Purchase Values <small>(apx)</small></th>
                                <th>Current Stock Sell Value <small>(apx)</small></th>
