...
@section('content')
                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Dropdown-->
                                ...
                                <a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" data-target="#modal_update_sale_price">
                                    <i class="la la-plus"></i>
                                    Update Sale Price
                                </a>&nbsp;&nbsp;&nbsp;
                                <a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" data-target="#modal_product_stock">
                                    <i class="la la-plus"></i>
                                    Update Stock
                                </a>
    ...
    <div class="modal fade" id="modal_update_sale_price" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered form-popup" id="user-edit">
    ...
    <div class="modal fade" id="modal_product_stock" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered form-popup" id="user-edit">
    ...
    @push('datatable-js')
        <script src="{{asset('assets/js/pages/admin_settings/brands.js')}}"></script>
    @endpush

    @push('js')
        <script src="{{asset('assets/js/pages/crud/forms/validation/admin_settings/brands.js')}}"></script>
    @endpush
