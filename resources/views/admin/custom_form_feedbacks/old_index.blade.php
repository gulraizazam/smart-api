            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th>@lang('global.custom_form_feedbacks.fields.patient_id')</th>
                    ...
                    <tr role="row" class="filter">
                        <td></td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="id" value="{{ $filters->get(Auth::User()->id, 'custom_form_feedbacks', 'id') }}">
                        </td>
                        <td>
