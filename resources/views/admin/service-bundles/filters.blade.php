<div class="d-flex align-items-center flex-wrap" style="gap: 5px;">
    <input type="text" class="form-control form-control-sm" placeholder="Search by service name..." id="search_name" style="max-width: 200px; flex: 1 1 140px;">
    <select class="form-control form-control-sm" id="search_category" style="max-width: 160px; flex: 0 1 160px;">
