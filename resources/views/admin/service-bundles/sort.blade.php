...
@section('title', 'Sort Bundle Categories')
@section('content')
    <style>
        ...
        .sort-name { font-size: 13px; color: #3F4254; }
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        @include('admin.partials.breadcrumb', ['module' => 'Sort Bundle Categories', 'title' => 'Sort Bundle Categories'])
                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Sort Bundle Categories</h3>
                        </div>
                        <div class="card-toolbar">
                            <a href="{{ route('admin.service-bundles.index') }}" class="btn btn-sm btn-light-primary">
    ...
    @push('js')
        ...
        <script src="{{ asset('assets/js/pages/service-bundles-sort.js') }}"></script>
    @endpush
@endsection
