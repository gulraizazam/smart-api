<div id="cs_field_{{$field_id}}" class="form-group mt-repeater update-question-fields cf_field ui-state-default cf_field_option_select">
    ...
    <div class="mt-repeater-cell form-group form-md-line-input">
        <div class="cf-q-option-list">
            ...
            <div id="field" class="mt-repeater-cell rs-shrt cf-q-option-list-item">
                <label class="optlbl">
                    <input type="text" class="form-control optinput" id="field" name="field[]" placeholder="Short Answer" value="{{$option["label"]}}">
                </label>
            ...
            <div id="field" class="mt-repeater-cell rs-shrt cf-q-option-list-item">
                <label class="optlbl">
                    <input type="text" class="form-control optinput" id="field" name="field[]" placeholder="Short Answer">
                </label>
            </div>
        </div>
