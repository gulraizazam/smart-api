<div id="cs_field_{{$field_id}}" class="form-group mt-repeater update-question-fields cf_field ui-state-default cf_field_single_select">
<div class="drag-button text-center"><i style="color: #000;" class="las la-bars"></i></div>
    ...
    <div class="form-group form-md-line-input cf-question-title">
        <input id="question" name="question" type="text" placeholder="Question" value="{{$title}}" class="form-control mt-repeater-input-line under-border" />
    </div>
            ...
            <div class="md-radio-list cf-q-option-list">
                ...
                <div class="md-radio mt-repeater-cell cf-q-option-list-item">
                    <label>
                        ...
                        <span class="box"></span><input id="field" type="text" class="form-control" name="field[]" placeholder=" Option" value="{{$option["label"]}}">
                    </label>
                ...
                <div class="md-radio mt-repeater-cell cf-q-option-list-item">
                    <label>
                        <span></span>
                        <span class="check"></span>
                        <span class="box"></span> <input id="field" type="text" class="form-control" name="field[]" placeholder=" Option">
                    </label>
                </div>
            </div>
