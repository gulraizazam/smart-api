...
@section('content')
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Sort Lead Sources', 'title' => 'Sort Lead Sources'])
                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Sort Lead Sources</h3>
                        </div>
    ...
    @push('js')
        ...
        <!--end::Page Vendors-->
        <script src="{{asset('assets/js/pages/admin_settings/lead_sources_sort.js')}}"></script>
    @endpush
