...
@section('content')
    ...
    @include('admin.partials.breadcrumb', ['module' => 'Rota Management List', 'title' => 'Rota Management'])
                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Rota Management</h3>
                        </div>
                    ...
                    <div class="card-body">
                        <!--begin::Search Form-->
                    @include('admin.resourcerotas.filters')
                    <!--end::Search Form-->
