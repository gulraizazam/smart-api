...
<div class="modal-content">
    ...
    <div class="modal-header" id="kt_modal_password_header">
        <!--begin::Modal title-->
        <h2 class="fw-bolder">Add Rota</h2>
        <!--end::Modal title-->
        <!--begin::Close-->
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        <!--begin::Form-->
        <form id="modal_resourcerotas_form" method="post" action="{{route('admin.resourcerotas.store')}}">
            <!--begin::Scroll-->
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="fv-row col-md-12 mt-5 resource_fields d-none" id="machine_field">
                            ...
                            <select id="machine_id" class="form-control form-control-solid mb-3 mb-lg-0 select2" name="machine_id">
                        ...
                        <div class="fv-row col-md-12 mt-5 resource_fields d-none" id="doctor_field">
                            ...
                            <select id="doctor_id" class="form-control form-control-solid mb-3 mb-lg-0 select2" name="doctor_id">
                    ...
                    <div class="row mt-10 hideonmbl">
                        ...
                        <div class="fv-row col-md-4">
                            ...
                            <label class="checkbox check_final_1">
                                <input id="mondayElement_1" type="checkbox" name="mondaychecked" class="mr-2">
                                <span></span>
                            </label>
                            ...
                            <div class="ml-2">
                                ...
                                <strong style="font-size: 12px;border-bottom: 1px solid #333; cursor: pointer;">Copy As All</strong>
                    ...
                    <div class="row mt-10 hideonmbl">
                        ...
                        <div class="fv-row col-md-4">
                            <label class="checkbox">
                                <input type="checkbox" name="Checkboxes1" class="mr-2">
                                <span></span>&nbsp;&nbsp;<strong>Tuesday</strong>
                            </label>
                        </div>
                    ...
                    <div class="row mt-10 hideonmbl">
                        ...
                        <div class="fv-row col-md-4">
                            <label class="checkbox">
                                <input type="checkbox" name="Checkboxes1" class="mr-2">
                                <span></span>&nbsp;&nbsp;<strong>Wednesday</strong>
                            </label>
                        </div>
                    ...
                    <div class="row mt-10 hideonmbl">
                        ...
                        <div class="fv-row col-md-4">
                            <label class="checkbox">
                                <input type="checkbox" name="Checkboxes1" class="mr-2">
                                <span></span>&nbsp;&nbsp;<strong>Thursday</strong>
                            </label>
                        </div>
                    ...
                    <div class="row mt-10 hideonmbl">
                        ...
                        <div class="fv-row col-md-4">
                            <label class="checkbox">
                                <input type="checkbox" name="Checkboxes1" class="mr-2">
                                <span></span>&nbsp;&nbsp;<strong>Friday</strong>
                            </label>
                        </div>
                    ...
                    <div class="row mt-10 hideonmbl">
                        ...
                        <div class="fv-row col-md-4">
                            <label class="checkbox">
                                <input type="checkbox" name="Checkboxes1" class="mr-2">
                                <span></span>&nbsp;&nbsp;<strong>Saturday</strong>
                            </label>
                        </div>
                    ...
                    <div class="row mt-10 hideonmbl">
                        ...
                        <div class="fv-row col-md-4">
                            <label class="checkbox">
                                <input type="checkbox" name="Checkboxes1" class="mr-2">
                                <span></span>&nbsp;&nbsp;<strong>Sunday</strong>
                            </label>
                        </div>
